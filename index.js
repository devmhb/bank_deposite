...
// Total_Amount
    ...
    const total_newAmount = parseFloat(total_amount)
// Deposite
    ...
    depositBtn.addEventListener("click", () => {
        ...
        document.getElementById('total_amount').innerHTML = total_newAmount + total_deposite ;
...
// Withdraw
    ...
    withdrawBtn.addEventListener("click", () => {
        ...
        document.getElementById('total_amount').innerHTML = total_newAmount - total_withdraw;
